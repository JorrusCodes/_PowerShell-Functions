<#
    ...
    Description: A simple function to present a Yes/No prompt and record whether "Yes"
    was selected or not. "No" and null result (pop-up with closed without a button press)
    both return $false
#>

# Display a Yes/No prompt and return $true if "Yes" was clicked and $false if not
function popupYesNo {
    param (
